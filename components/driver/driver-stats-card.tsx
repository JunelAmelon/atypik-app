    ...
    <Card className="border-0 shadow-lg overflow-hidden bg-gradient-to-br from-white to-primary/5 dark:from-gray-800 dark:to-gray-700/80 rounded-xl border-t-4 border-t-primary">
      <CardHeader className="pb-3 relative z-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-base sm:text-lg whitespace-nowrap">Statistiques</h3>
      ...
      <CardContent className="relative z-10">
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-white to-yellow-50/50 dark:from-background dark:to-yellow-900/5 p-3 sm:p-4 rounded-xl border border-yellow-200/50 dark:border-yellow-800/20 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm font-medium text-yellow-800 dark:text-yellow-300">Note moyenne</span>
              </div>
              <div className="flex items-center">
                <motion.span
                  ...
                  className="text-2xl sm:text-3xl font-bold text-yellow-700 dark:text-yellow-400"
                >
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 dark:from-background dark:to-teal-900/5 p-3 sm:p-4 rounded-xl border border-teal-200/50 dark:border-teal-800/20 shadow-sm">
                ...
                <div className="flex items-baseline">
                  <motion.p
                    ...
                    className="text-xl sm:text-2xl font-bold text-teal-700 dark:text-teal-400"
                  >
