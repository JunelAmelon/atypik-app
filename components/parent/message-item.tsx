...
import { Reply, MoreHorizontal, Download, User, FileText, Image, Video, Music, Archive, Trash2 } from 'lucide-react';
                  ...
                  <div key={index} className="flex items-start sm:items-center gap-2 p-2 sm:p-3 rounded-lg bg-background/20 hover:bg-background/30 transition-colors min-w-0">
                    ...
                    <div className="flex-shrink-0 ml-1">
                      <Button 
                        variant="ghost" 
                        size="sm" 
                        className="h-6 w-6 sm:h-8 sm:w-8 p-1 sm:p-2 hover:bg-background/40"
